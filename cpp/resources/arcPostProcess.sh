...
ffmpeg -f rawvideo -vcodec rawvideo -s $RES_W'x'$RES_H -r $FPS -pix_fmt argb -i $PATH_OUT/producer-camera.$RES_W'x'$RES_H -c:v libx264 -preset ultrafast -qp 0 $PATH_OUT/producer-camera.avi &>> $PATH_OUT/arc_PostProcess.log
echo '==================================\n' &>> $PATH_OUT/arc_PostProcess.log
...
ffmpeg -framerate $FPS -i $PATH_OUT/frames_padded/%01d.png -c:v libx264 -crf 0 -r $FPS -preset ultrafast -pix_fmt argb $PATH_OUT/producer-camera_padded.avi &>> $PATH_OUT/arc_PostProcess.log
echo '==================================\n' &>> $PATH_OUT/arc_PostProcess.log
...
./resources/vmaf/run_vmaf yuv420p $RES_W $RES_H $PATH_OUT/in_$RES_W'x'$RES_H'_adjusted'.avi $PATH_OUT/producer-camera_padded'_adjusted'.avi --out-fmt json &>> $PATH_OUT/arc_PostProcess.log
echo '==================================\n' &>> $PATH_OUT/arc_PostProcess.log
